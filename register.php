...
<head>
    ...
    <!-- Icons font CSS-->
    <link href="Login/vendot/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">
    <link href="Login/vendot/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <!-- Font special for pages-->
    <link href="https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

    <!-- Vendor CSS-->
    <link href="Login/vendot/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="Login/vendot/datepicker/daterangepicker.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="Login/cst/main.css" rel="stylesheet" media="all">
                                            ...
                                            <div class="row">
                                                 ...
                                                 <!--<div align="center">
                                                   <div class="heading-section">
                                                        <h4><em>register</em>  <?=$data['album_a'];?></h4>
                                                    </div>
                                                </div>   -->
...
<div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                    <img src="assets/images/regis.jpg" alt="" style="border-radius: 23px;">
                  </div>
                 ...
                 <div class="col-lg-4 align-self-center">
                  ...
                  <h4><em>register</em>  </h4>
                       ...
                       <!-- <div class="input-group">
                        ...
                        <button  id="Submit" name="Submit" class="main-button" type="Submit">Submit</button>
                        </form>
   ...
   include("connectdb.php");
	...
	$sql = "INSERT INTO `customer` (`cus_id`, `cus_name`, `cus_phone`, `cus_adress`, `cus_user`, `cus_pwd`) VALUES ";
...
?>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div align="center">
                                                            ...
                                                            <div class="main-info header-text">
                                                                ...
                                                                <a href="memberlogin.php" role="button">Go to Login</a>
    ...
    <script src="Login/vendot/jquery/jquery.min.js"></script>
    <!-- Vendor JS-->
    <script src="Login/vendot/select2/select2.min.js"></script>
    <script src="Login/vendot/datepicker/moment.min.js"></script>
    <script src="Login/vendot/datepicker/daterangepicker.js"></script>

    <!-- Main JS-->
    <script src="Login/jt/global.js"></script>
